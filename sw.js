...
const CORE = ["./index.html","./manifest.webmanifest","./mochi-builtin.webp","./mochi-watermark.webp","./euna-avatar.webp","./science-body.webp","./science-cart.webp","./science-heat.webp","./science-plant.webp","./science-pond.webp","./course/assets/inquiry-workbench.webp","./course/assets/living-world.webp","./course/assets/maths-workbench.webp","./course/assets/plant-study.webp","./course/assets/science-bench.webp","./course/assets/water-landscape.webp","./apple-touch-icon.png?v=5.0.1","./favicon.png?v=5.0.1","./tutor.css?v=5.0.1","./studio.css?v=5.0.1","./science.css?v=5.0.1","./responsive.css?v=5.0.1","./lesson-layout.css?v=5.0.1","./course.css?v=5.0.1","./course-data.js?v=5.0.1","./course-core.js?v=5.0.1","./course-visuals.js?v=5.0.1","./reasoning.js?v=5.0.1","./learning.js?v=5.0.1","./question-bank.js?v=5.0.1","./challenge-bank.js?v=5.0.1","./transfer-bank.js?v=5.0.1","./adaptive-repair.js?v=5.0.1","./app.js?v=5.0.1","./input-mode.js?v=5.0.1","./study-ui.js?v=5.0.1","./science-core.js?v=5.0.1","./science-scenes.js?v=5.0.1","./science-ui.js?v=5.0.1","./learning-review.js?v=5.0.1","./studio.js?v=5.0.1","./baseline-week.js?v=5.0.1","./responsive.js?v=5.0.1","./review-ui.js?v=5.0.1","./network.js?v=5.0.1","./cloud-sync.js?v=5.0.1","./cloud-backup.js?v=5.0.1","./drive-mirror.js?v=5.0.1","./course-ui.js?v=5.0.1","./icon-192.png?v=5.0.1"]; // Generated from index.html.
