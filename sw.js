...
const SHELL = 'mochi-shell-v2.1.0';
const FONTS = 'mochi-fonts-v1';          // separate bucket: code deploys never evict fonts
const ASSETS = ['./', './index.html', './app.js?v=2.1.0', './learning.js?v=2.1.0', './question-bank.js?v=2.1.0', './study-ui.js?v=2.1.0', './tutor.css?v=2.1.0', './challenge-bank.js?v=2.1.0', './reasoning.js?v=2.1.0', './studio.js?v=2.1.0', './studio.css?v=2.1.0', './manifest.webmanifest',
