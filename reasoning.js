...
const probes={
 number:{question:'Without calculating exactly, which is closest to 49 × 21?',choices:['100','1,000','10,000'],answer:1,explanation:'50 × 20 is 1,000. An estimate helps you check the size before exact calculation.',checks:'size and place value'},
 fraction:{question:'Two same-sized cakes: one is cut into thirds, the other into sixths. Which is the same amount as 1/3?',choices:['1/6','2/6','3/6'],answer:1,explanation:'One third contains two sixths. Equal fractions cover the same amount of the same whole.',checks:'equal parts of a common whole'},
 ...
 measure:{question:'The same ribbon measures 2 m. In centimetres its number is…',choices:['Smaller than 2','Still 2','Larger than 2'],answer:2,explanation:'Centimetres are smaller units, so more of them are needed for the same length.',checks:'unit-size relationship'},
 time:{question:'How long from 10:50 to 11:10?',choices:['20 minutes','40 minutes','60 minutes'],answer:0,explanation:'Ten minutes to 11:00, then ten more minutes: 20 minutes altogether.',checks:'bridging the hour'},
 area:{question:'Which calculation finds the space inside a rectangle 3 cm by 5 cm?',choices:['3 × 5','2 × (3 + 5)','3 + 5'],answer:0,explanation:'Area counts square units inside: 3 rows of 5 squares. Perimeter measures the boundary.',checks:'area versus perimeter'},
...
function nextMove(l,skill,obstacle=''){
 ...
 if(obstacle==='meaning')return {title:'Name the unknown',prompt:'What exactly are you trying to find? Which information constrains it?'};
