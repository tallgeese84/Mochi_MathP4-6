...
function download(){
 ...
 document.getElementById('learningReviewStatus').textContent=`Downloaded v${data.source.appVersion}: ${m.sampled} maths records and ${s.sampled} science records. Attach this JSON here in ChatGPT and ask for Euna’s learning review.`;
}
function init(){
