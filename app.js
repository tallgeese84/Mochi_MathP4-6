...
const MOCHI_AVATAR = 'mochi-flat-avatar.svg?v=6.2.0';
...
if('serviceWorker' in navigator){
  document.addEventListener('mochi:ready', ()=> navigator.serviceWorker.register('sw.js?v=6.2.0',{updateViaCache:'none'}).catch(()=>{}),{once:true});
}
