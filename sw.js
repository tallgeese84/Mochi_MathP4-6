...
const CORE = ["./index.html","./manifest.webmanifest","./mochi-builtin.webp","./mochi-watermark.webp","./euna-avatar.webp","./mochi-room-scene.js?v=5.2.0","./vendor/three-r180/three.module.js","./vendor/three-r180/three.core.js","./science-body.webp","./science-cart.webp","./science-heat.webp","./science-plant.webp","./science-pond.webp","./course/assets/inquiry-workbench.webp","./course/assets/living-world.webp","./course/assets/maths-workbench.webp","./course/assets/plant-study.webp","./course/assets/science-bench.webp","./course/assets/water-landscape.webp","./apple-touch-icon.png?v=5.2.0","./favicon.png?v=5.2.0","./tutor.css?v=5.2.0","./studio.css?v=5.2.0","./science.css?v=5.2.0","./responsive.css?v=5.2.0","./lesson-layout.css?v=5.2.0","./course.css?v=5.2.0","./planner.css?v=5.2.0","./mochi-room.css?v=5.2.0","./course-data.js?v=5.2.0","./course-core.js?v=5.2.0","./planner-core.js?v=5.2.0","./course-visuals.js?v=5.2.0","./reasoning.js?v=5.2.0","./learning.js?v=5.2.0","./question-bank.js?v=5.2.0","./challenge-bank.js?v=5.2.0","./transfer-bank.js?v=5.2.0","./adaptive-repair.js?v=5.2.0","./app.js?v=5.2.0","./input-mode.js?v=5.2.0","./study-ui.js?v=5.2.0","./science-core.js?v=5.2.0","./science-scenes.js?v=5.2.0","./science-ui.js?v=5.2.0","./learning-review.js?v=5.2.0","./studio.js?v=5.2.0","./responsive.js?v=5.2.0","./review-ui.js?v=5.2.0","./network.js?v=5.2.0","./cloud-sync.js?v=5.2.0","./cloud-backup.js?v=5.2.0","./drive-mirror.js?v=5.2.0","./course-ui.js?v=5.2.0","./planner-ui.js?v=5.2.0","./mochi-room.js?v=5.2.0","./icon-192.png?v=5.2.0"]; // Generated from index.html.
