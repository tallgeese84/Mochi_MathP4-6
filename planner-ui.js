...
function init(){
 ...
 root.MochiPlanUI={pause,start:subject=>{if(clock.subject!==subject)start(subject);},running:()=>clock.subject,status:()=>message,flush:()=>tick(true),refresh:()=>{clock.stop();schedulePaint();paint();}};
